...
// Secure storage helpers (fallback to AsyncStorage if SecureStore fails)
...
const secureGet = async (key) => {
    try {
        ...
        console.warn('SecureStore failed, trying AsyncStorage:', error);
    }
...
const secureDelete = async (key) => {
    try {
        ...
        console.warn('SecureStore delete failed, using AsyncStorage:', error);
    }
